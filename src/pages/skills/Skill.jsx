    ...
    <>
      <div className="w-full h-[1000px] bg-[#232a3f]">
        <div className="w-full lg:w-3/5 mx-auto h-full">
          ...
          <div className="mt-6 flex flex-wrap pl-4">
              ...
              <img src={Javascript} alt="Javascript" className='lg:w-32 lg:h-32 mx-2 my-2 h-24 mr-4 object-cover hover:scale-110 transition-transform duration-300' />
          ...
          <div className="mt-6 flex flex-wrap pl-4">
                ...
                <img src={Mysql} alt="Javascript" className='lg:w-32 lg:h-32 mx-2 my-2 h-24 mr-4 object-cover hover:scale-110 transition-transform duration-300' />
          ...
          <div className="mt-6 flex flex-wrap pl-4">
                ...
                <img src={Solidity} alt="Javascript" className='lg:w-32 lg:h-32 mx-2 my-2 h-24 mr-4 object-cover hover:scale-110 transition-transform duration-300' />
