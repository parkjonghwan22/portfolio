...
export const Cloneproject = () => {
    return (
        <>
            ...
            <img src={Clone} alt="NFT" className='w-full h-full object-cover hover:scale-105 transition-transform duration-300 rounded-lg' />

            </div>
            <div className="w-3/5 flex flex-col px-3 py-3 text-[#8f98b3]">
              <h1 className="font-bold text-5xl text-white">클론코딩 프로젝트</h1>
