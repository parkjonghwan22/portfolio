...
export const GptModal = () => {
    return (
        ...
        <div className="mt-10 lg:flex">
            <div>
                <img src="https://github.com/parkjonghwan22/project3/assets/118948122/9bdd5a0a-e14c-4637-b8a5-ad4e2363f9ba" className="w-full min-w-[400px] sm:h-[300px] lg:h-[400px]"/>
