...
import { GptMusic } from "../../common/images";
...
export const Musicproject = () => {
    return (
        <>
            ...
            <img src={GptMusic} alt="NFT" className='w-full h-full object-fill hover:scale-105 transition-transform duration-300 rounded-lg' />
